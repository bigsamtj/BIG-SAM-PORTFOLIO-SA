...
const expertiseData = [
  {
    ...
    text: "Conducting digital forensic examinations across computer, mobile, cloud, memory, and network environments, with a focus on evidence preservation, artifact analysis, timeline reconstruction, and actionable forensic reporting.",
  ...
  },
  {
    ...
    text: "Reconstructing digital events through evidence correlation, OSINT, cyber threat intelligence, online investigations, behavioral analysis, and investigative reasoning to establish what happened, how it happened, and what the evidence supports.",
  ...
  },
  {
    ...
    text: "Assessing attack surfaces through reconnaissance, network enumeration, vulnerability assessment, web application security, API security, and controlled offensive security testing.",
  ...
  },
  {
    ...
    text: "Exploring emerging vulnerabilities, attack techniques, digital threats, and defensive strategies while translating technical findings into practical security knowledge and investigative capability.",
    tag: "THREAT RESEARCH",
  ...
  },
  {
    ...
    text: "Exploring the security of intelligent systems through adversarial machine learning, AI attack surfaces, model security, prompt injection, AI-assisted cyber operations, and intelligent threat detection.",
    tag: "AI SECURITY",
    gradient: "from-[#20090b] via-[#121212] to-[#090909]"
  },
  {
    number: "06",
    title: "Software Engineering & Design",
    text: "Developing and exploring secure digital products through frontend and backend development, application architecture, APIs, databases, automation, and human-centered software design.",
    tag: "ENGINEERING & DESIGN",
    gradient: "from-[#18080a] via-[#111111] to-[#080808]"
  }
];
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed max-w-xs">
            Bridging digital investigation, cybersecurity, intelligence, research, and software engineering to understand, secure, and build digital systems.
          </p>
        </div>
