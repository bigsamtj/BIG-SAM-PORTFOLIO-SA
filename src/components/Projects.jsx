...
const projectsData = [
  {
    ...
    tags: ["Mobile Forensics", "SIM Swap", "Fraud Investigation", "Timeline Analysis"],
    match: "CASE",
    episode: "CASE 01"
  },

  {
    ...
    tags: ["Digital Forensics", "Steganography", "Password Recovery", "Automation"],
    match: "LAB",
    episode: "CASE 02"
  },

  {
    ...
    tags: ["Network Security", "ARP Spoofing", "Wireshark", "Packet Analysis"],
    match: "LAB",
    episode: "CASE 03"
  },

  {
    ...
    tags: ["Cryptography", "OpenSSL", "TLS", "Wireshark"],
    match: "LAB",
    episode: "CASE 04"
  },

  {
    ...
    tags: ["Digital Forensics", "Firmware Analysis", "Hex Analysis", "Binwalk"],
    match: "CASE",
    episode: "CASE 05"
  },

  {
    ...
    tags: ["Ethical Hacking", "Reconnaissance", "Nmap", "Nessus"],
    match: "LAB",
    episode: "CASE 06"
  },

  {
    ...
    tags: ["Cryptography", "DES", "Encryption", "Security Research"],
    match: "RESEARCH",
    episode: "CASE 07"
  },
